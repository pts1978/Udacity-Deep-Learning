...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # as shown below
        self.activation_function = lambda x : 1/(1+np.exp(-x))  # Replace 0 with your sigmoid calculation. --> DONE
    ...
    def forward_pass_train(self, X):
        ...
        ### Forward pass ###
        # TODO: Hidden layer - Replace these values with your calculations. --> DONE
        ...
        # TODO: Output layer - Replace these values with your calculations. --> DONE
        final_inputs = np.dot(hidden_outputs, self.weights_hidden_to_output) # None # signals into final output layer
        final_outputs = final_inputs # self.activation_function(final_inputs) # None # signals from final output layer
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # output_error_term = error * final_outputs * (1 - final_outputs) # None
        # print('output_error_term:', output_error_term.shape, output_error_term)
        
        # TODO: Calculate the hidden layer's contribution to the error
        hidden_error = np.dot(self.weights_hidden_to_output, error) # None
        # print('hidden_error:', hidden_error.shape, hidden_error)
        hidden_error_term = hidden_error * hidden_outputs * (1 - hidden_outputs) # None
        # print('hidden_error_term:', hidden_error_term.shape, hidden_error_term)
        
        # Weight step (input to hidden)
        delta_weights_i_h += hidden_error_term * X[:, None] # None
        # print('delta_weights_i_h:', delta_weights_i_h.shape, delta_weights_i_h)
        
        # Weight step (hidden to output)
        delta_weights_h_o += error * hidden_outputs[:,None] # None
        # print('delta_weights_h_o:', delta_weights_h_o.shape, delta_weights_h_o)
    ...
    def run(self, features):
        ...
        final_outputs = np.dot(final_inputs, self.weights_hidden_to_output) # None # signals from final output layer 
...
##########################################################
iterations = 200
learning_rate = 0.01 # typical initial learning rate
hidden_nodes = 56 # = number of input features
output_nodes = 1
